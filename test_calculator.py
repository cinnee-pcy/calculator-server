...
def test_decimal_percent():
    ...
    assert expand_percent("100 - 5.5%") == "100 - ((5.5/100)*100)"
    assert expand_percent("0.5%") == "(0.5/100)"


def test_expression_without_percent():
    """Test standard mathematical expressions without % symbol."""
    assert expand_percent("10 + 20 * 3") == "10 + 20 * 3"